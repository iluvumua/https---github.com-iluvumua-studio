...
export const equipmentData: Equipment[] = [
  { id: 'EQP-001', name: 'ALU_SO_ERR5_MSI11_7302', type: 'MSI', location: 'ERR5', status: 'En service', lastUpdate: '2023-10-25', fournisseur: 'Alcatel Lucent', typeChassis: '7302', districtSteg: 'SOUSSE CENTRE', coordX: 10.5921583, coordY: 35.7995278, designation: 'ALU-Erriadh5-Rk_01-Sh_A-7302', compteurId: '542440', dateMiseEnService: '2023-01-15' },
  { id: 'EQP-002', name: 'NSN_SO_EZZH_MSI11_5625-G400', type: 'MSI', location: 'EZZH', status: 'En service', lastUpdate: '2023-10-24', fournisseur: 'Siemens', typeChassis: '5625-G400', districtSteg: 'SOUSSE CENTRE', coordX: 10.585829, coordY: 35.791822, designation: 'Hix_Ezzouhour_1-1', compteurId: '542300', dateMiseEnService: '2023-02-20' },
  { id: 'EQP-003', name: 'ALU_SO_HRGL_MSI21_7330', type: 'MSI', location: 'HRGL', status: 'En cours', lastUpdate: '2023-09-15', fournisseur: 'Alcatel Lucent', typeChassis: '7330', districtSteg: 'SOUSSE NORD', coordX: 10.51041, coordY: 36.028373, designation: 'ALU-Hergla-Sh_A-7330', verifiedBy: 'Admin' },
  { id: 'EQP-004', name: 'ALU_SO_KANT_MSN01_MM_Immeuble Zarrouk_7353', type: 'MSN', location: 'KANT', status: 'En service', lastUpdate: '2023-10-26', fournisseur: 'Alcatel Lucent', typeChassis: '7353', districtSteg: 'SOUSSE NORD', coordX: 10.589497, coordY: 35.886259, designation: 'ALU_SO_MM_Immeuble Zarrouk _FTTB', compteurId: '537400', dateMiseEnService: '2022-05-10' },
  { id: 'EQP-005', name: 'HUW_SO_CENN_MSN01_T300', type: 'MSN', location: 'CENN', status: 'Résilié', lastUpdate: '2023-10-22', fournisseur: 'Huawei', typeChassis: 'T300', districtSteg: 'SOUSSE CENTRE', coordX: 10.587450, coordY: 35.735262, designation: 'HW_SO_Cite_Ennour1_T300' },
  { id: 'EQP-006', name: 'ALU_SO_REP_MSI01_7330', type: 'MSI', location: 'SO01', status: 'En cours', lastUpdate: '2023-11-01', fournisseur: 'Alcatel Lucent', typeChassis: '7330', districtSteg: 'SOUSSE CENTRE', coordX: 10.638617, coordY: 35.829169, designation: 'ALU-Republique-Rk_01-Sh_A-7330' },
];
...
export const billingData: Bill[] = [
    { id: 'BILL-0823-01', reference: '2023080000001', meterId: '552200', month: 'Août 2023', amount: 8911.22, consumptionKWh: 25499, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire' },
    { id: 'BILL-0823-02', reference: '2023080000002', meterId: '542300', month: 'Août 2023', amount: 5252.54, consumptionKWh: 14938, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire' },
    { id: 'BILL-0923-01', reference: '2023090000001', meterId: '542440', month: 'Septembre 2023', amount: 2658.48, consumptionKWh: 7471, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire' },
    { id: 'BILL-0923-02', reference: '2023090000002', meterId: '545040', month: 'Septembre 2023', amount: 49847.26, consumptionKWh: 148560, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire' },
    { id: 'BILL-1023-01', reference: '2023100000001', meterId: '597878951', month: 'Octobre 2023', amount: 1280.40, consumptionKWh: 5350, status: 'Impayée', typeTension: 'Basse Tension' },
    { id: 'BILL-1023-02', reference: '2023100000002', meterId: '587687455', month: 'Octobre 2023', amount: 5100.00, consumptionKWh: 22800, status: 'Impayée', typeTension: 'Moyen Tension Forfaitaire' },
];
