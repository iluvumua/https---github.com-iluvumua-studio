...
export const billingData: Bill[] = [
    { id: 'BILL-0823-01', reference: '2023080000001', meterId: '552200', month: 'Août 2023', amount: 8911.22, consumptionKWh: 25499, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-0823-02', reference: '2023080000002', meterId: '542300', month: 'Août 2023', amount: 5252.54, consumptionKWh: 14938, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-0923-01', reference: '2023090000001', meterId: '542440', month: 'Septembre 2023', amount: 2658.48, consumptionKWh: 7471, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-0923-02', reference: '2023090000002', meterId: '545040', month: 'Septembre 2023', amount: 49847.26, consumptionKWh: 148560, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-1023-01', reference: '2023100000001', meterId: '597878951', month: 'Octobre 2023', amount: 1280.40, consumptionKWh: 5350, status: 'Impayée', typeTension: 'Basse Tension', convenableSTEG: true, nombreMois: 2 },
    { id: 'BILL-1023-02', reference: '2023100000002', meterId: '587687455', month: 'Octobre 2023', amount: 5100.00, consumptionKWh: 22800, status: 'Impayée', typeTension: 'Moyen Tension Forfaitaire', convenableSTEG: true, nombreMois: 2 },
    { id: 'BILL-0723-01', reference: '2023070000001', meterId: '552200', month: 'Juillet 2023', amount: 9200.00, consumptionKWh: 26000, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-0723-02', reference: '2023070000002', meterId: '542300', month: 'Juillet 2023', amount: 4800.00, consumptionKWh: 14000, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-0623-01', reference: '2023060000001', meterId: '537400', month: 'Juin 2023', amount: 1500.00, consumptionKWh: 4500, status: 'Impayée', typeTension: 'Moyen Tension Forfaitaire', convenableSTEG: false, montantSTEG: 1550.00, nombreMois: 2 },
    { id: 'BILL-0623-02', reference: '2023060000002', meterId: '548710', month: 'Juin 2023', amount: 3200.00, consumptionKWh: 9000, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-1123-01', reference: '2023110000001', meterId: '597878951', month: 'Novembre 2023', amount: 1350.00, consumptionKWh: 5500, status: 'Impayée', typeTension: 'Basse Tension', convenableSTEG: true, nombreMois: 2 },
    { id: 'BILL-1123-02', reference: '2023110000002', meterId: '552200', month: 'Novembre 2023', amount: 8500.00, consumptionKWh: 24000, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-1223-01', reference: '2023120000001', meterId: '542300', month: 'Décembre 2023', amount: 5500.00, consumptionKWh: 15500, status: 'Impayée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-1223-02', reference: '2023120000002', meterId: '545040', month: 'Décembre 2023', amount: 48000.00, consumptionKWh: 140000, status: 'Payée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
    { id: 'BILL-0124-01', reference: '2024010000001', meterId: '537400', month: 'Janvier 2024', amount: 1800.00, consumptionKWh: 5000, status: 'Impayée', typeTension: 'Moyen Tension Forfaitaire', convenableSTEG: false, montantSTEG: 1800.00, nombreMois: 2 },
    { id: 'BILL-0224-01', reference: '2024020000001', meterId: '597878951', month: 'Février 2024', amount: 1400.00, consumptionKWh: 5800, status: 'Payée', typeTension: 'Basse Tension', convenableSTEG: true, nombreMois: 2 },
    { id: 'BILL-0324-01', reference: '2024030000001', meterId: '542440', month: 'Mars 2024', amount: 2800.00, consumptionKWh: 8000, status: 'Impayée', typeTension: 'Moyen Tension Tranche Horaire', convenableSTEG: true, nombreMois: 12 },
];
