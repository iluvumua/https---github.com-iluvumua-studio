...
export const metersData: Meter[] = [
    ...
    { id: '58768472354', policeNumber: '25-600001-99', typeTension: 'Basse Tension', status: 'En service', dateMiseEnService: '2024-01-10', description: 'Nouveau compteur pour équipement NSN à Ksiba', lastUpdate: '2024-01-10', districtSteg: 'SOUSSE CENTRE' },
    { id: '236415276', policeNumber: '25-600002-99', typeTension: 'Moyen Tension Tranche Horaire', status: 'En service', dateMiseEnService: '2024-02-15', description: 'Nouveau compteur pour équipement ALU à Sahloul', lastUpdate: '2024-02-15', districtSteg: 'SOUSSE CENTRE' },
];
