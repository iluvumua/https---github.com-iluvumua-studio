...
export const equipmentData: Equipment[] = [
  { id: 'EQP-001', name: 'ALU_SO_ERR5_MSI11_7302', type: 'MSI', location: 'ERR5', status: 'Active', lastUpdate: '2023-10-25', fournisseur: 'Alcatel Lucent', typeChassis: '7302', tension: 'MT', districtSteg: 'SOUSSE CENTRE', coordX: 10.5921583, coordY: 35.7995278, designation: 'ALU-Erriadh5-Rk_01-Sh_A-7302', compteurId: '542440', dateMiseEnService: '2023-01-15' },
  { id: 'EQP-002', name: 'NSN_SO_EZZH_MSI11_5625-G400', type: 'MSI', location: 'EZZH', status: 'Active', lastUpdate: '2023-10-24', fournisseur: 'Siemens', typeChassis: '5625-G400', tension: 'MT', districtSteg: 'SOUSSE CENTRE', coordX: 10.585829, coordY: 35.791822, designation: 'Hix_Ezzouhour_1-1' },
  { id: 'EQP-003', name: 'ALU_SO_HRGL_MSI21_7330', type: 'MSI', location: 'HRGL', status: 'En Attente d\'Installation', lastUpdate: '2023-09-15', fournisseur: 'Alcatel Lucent', typeChassis: '7330', tension: 'MT', districtSteg: 'SOUSSE NORD', coordX: 10.51041, coordY: 36.028373, designation: 'ALU-Hergla-Sh_A-7330', verifiedBy: 'Admin' },
  { id: 'EQP-004', name: 'ALU_SO_KANT_MSN01_MM_Immeuble Zarrouk_7353', type: 'MSN', location: 'KANT', status: 'Maintenance', lastUpdate: '2023-10-26', fournisseur: 'Alcatel Lucent', typeChassis: '7353', tension: 'MT', districtSteg: 'SOUSSE NORD', coordX: 10.589497, coordY: 35.886259, designation: 'ALU_SO_MM_Immeuble Zarrouk _FTTB' },
  { id: 'EQP-005', name: 'HUW_SO_CENN_MSN01_T300', type: 'MSN', location: 'CENN', status: 'Inactive', lastUpdate: '2023-10-22', fournisseur: 'Huawei', typeChassis: 'T300', tension: 'BT', districtSteg: 'SOUSSE CENTRE', coordX: 10.587450, coordY: 35.735262, designation: 'HW_SO_Cite_Ennour1_T300' },
  { id: 'EQP-006', name: 'ALU_SO_REP_MSI01_7330', type: 'MSI', location: 'SO01', status: 'Vérification Requise', lastUpdate: '2023-11-01', fournisseur: 'Alcatel Lucent', typeChassis: '7330', tension: 'MT', districtSteg: 'SOUSSE CENTRE', coordX: 10.638617, coordY: 35.829169, designation: 'ALU-Republique-Rk_01-Sh_A-7330' },
];
