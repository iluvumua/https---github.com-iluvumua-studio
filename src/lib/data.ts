...
export const metersData: Meter[] = [
    ...
    { id: '587687455', policeNumber: '25-587687455-99', referenceFacteur: '378051247', typeTension: 'Moyenne Tension', status: 'switched off', description: 'Ancien compteur pour équipement Huawei, maintenant résilié.', lastUpdate: '2023-10-22', districtSteg: 'SOUSSE CENTRE' },
